<template>
  <!-- 自定义对话框 -->
  <el-dialog
    :title="$t('PLUGIN.CUSTOM_DASHBOARD.TITLE')"
    width="1000px"
  ...
  >
    <el-row style="height: 500px" :gutter="20">
      ...
      <el-col :span="14">
        <el-tabs v-model="leftActive" type="card">
          <el-tab-pane
            :label="$t('PLUGIN.CUSTOM_DASHBOARD.TAB_PANE_LABEL1')"
            name="option"
          >
            <div class="option-pane-select-div" >
              ...
              <el-select
                v-model="seriesType"
                :placeholder="$t('PLUGIN.CUSTOM_DASHBOARD.PLACEHOLDER1')"
            ...
            <el-input
              ...
              type="textarea"
              :placeholder="$t('PLUGIN.CUSTOM_DASHBOARD.PLACEHOLDER2')"
              :autosize="{ minRows: 20, maxRows: 20 }"
              v-model="jsonOptionText"
          ...
          <!-- 模拟数据 -->
          <el-tab-pane
            :label="$t('PLUGIN.CUSTOM_DASHBOARD.TAB_PANE_LABEL2')"
            name="random"
          >
            <div class="random-pane-div">
              ...
              >
                <el-form-item>
                  <el-checkbox
                    v-model="startRandom"
                    @change="changeRandomState"
                    >{{ $t("PLUGIN.CUSTOM_DASHBOARD.CHECKBOX") }}</el-checkbox
                  >
                </el-form-item>
              ...
              <el-tabs v-model="randomTabsValue" type="card">
                <el-tab-pane
                  v-for="item in randomTabs"
                  :key="item.name"
                  :label="item.title"
                  :name="item.name"
                >
                  <el-input
                    style="height: 250px; overflow-y: auto;background-color:azure !important;"
                    type="textarea"
                    :placeholder="$t('PLUGIN.CUSTOM_DASHBOARD.PLACEHOLDER3')"
          ...
          <el-tab-pane
            class="ui-tab-pane"
            :label="$t('PLUGIN.CUSTOM_DASHBOARD.TAB_PANE_LABEL3')"
            name="ui"
          >
            <el-tabs v-model="styleTabsValue">
              <el-tab-pane
                v-for="(item, index) in styleTabs"
                :key="index"
                :label="item.title"
                :name="item.name"
              >
                ...
                >
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE2')">
                    <el-input-number
                      v-model="chartStyle[index].detail.fontSize"
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE3')">
                    <el-color-picker
                      v-model="chartStyle[index].detail.color"
                      @change="handleChangeStyle"
                    ></el-color-picker>
                  </el-form-item>
                  <!-- 当前值文本后缀 "" -->
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE6')">
                    <el-switch
                      v-model="chartStyle[index].pointer.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE7')">
                    <el-color-picker
                      v-model="chartStyle[index].itemStyle.color"
                      @change="handleChangeStyle"
                    ></el-color-picker>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE8')">
                    <el-switch
                      v-model="chartStyle[index].progress.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE9')">
                    <el-input-number
                      v-model="chartStyle[index].progress.width"
                      @change="handleChangeStyle"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE10')">
                    <el-switch
                      v-model="chartStyle[index].axisLine.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE11')">
                    <el-input-number
                      v-model="chartStyle[index].axisLine.lineStyle.width"
                      @change="handleChangeStyle"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE12')">
                    <el-switch
                      v-model="chartStyle[index].axisLabel.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE13')">
                    <el-color-picker
                      v-model="chartStyle[index].axisLabel.color"
                      @change="handleChangeStyle"
                    ></el-color-picker>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE14')">
                    <el-input-number
                      v-model="chartStyle[index].axisLabel.fontSize"
                      @change="handleChangeStyle"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE15')">
                    <el-input-number
                      v-model="chartStyle[index].axisLabel.distance"
                      @change="handleChangeStyle"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE16')">
                    <el-switch
                      v-model="chartStyle[index].splitLine.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE17')">
                    <el-input-number
                      v-model="chartStyle[index].splitLine.length"
                      @change="handleChangeStyle"
                    ></el-input-number>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE18')">
                    <el-switch
                      v-model="chartStyle[index].axisTick.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                  ...
                  <el-form-item :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE19')">
                    <el-switch
                      v-model="chartStyle[index].anchor.show"
                      @change="handleChangeStyle"
                    ></el-switch>
                  </el-form-item>
                </el-form>
      ...
      <el-col :span="10">
        <el-tabs v-model="rightActive" type="card">
          <el-tab-pane
            :label="$t('PLUGIN.CUSTOM_DASHBOARD.LABLE20')"
            name="preview"
          >
            <div
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="cancel" @click="dialogVisible = false">{{
        $t("PLUGIN.CUSTOM_DASHBOARD.CANCEL")
      }}</el-button>
      <el-button type="save" @click="submit">{{
        $t("PLUGIN.CUSTOM_DASHBOARD.CONFIRM")
      }}</el-button>
    </span>
  </el-dialog>
</template>
...
export default {
  ...
  watch: {
    ...
    currentValueEnds: {
      handler(newValue) {
        let option = {
          series: [{ detail: { formatter: "{value}" + newValue } }],
        };
        this.myChart.setOption(option);
      },
    },
    ...
    jsonOptionInput(value) {
      ...
      for (let i = 0; i < this.customOption.series.length; i++) {
        ...
        this.styleTabs.push({
          title: "表盘" + (i + 1),
          name: "dashboard" + (i + 1),
          value: this.customOption.series[i],
        });
